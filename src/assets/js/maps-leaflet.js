...
(function () {
  ...
  if (shapeMapVar) {
    const markerMap = L.map('shapeMap').setView([14.6673, 121.0431], 16);
    const marker = L.marker([14.6673, 121.0431]).addTo(markerMap);
    const circle = L.circle([14.6673, 121.0431], {
      color: 'red',
      fillColor: '#f03',
      fillOpacity: 0.5,
      radius: 500
