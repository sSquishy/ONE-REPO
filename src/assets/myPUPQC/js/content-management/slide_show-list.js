$(function () {
  ...
  if (dt_slideshow_table.length) {
    dt_slideshow = dt_slideshow_table.DataTable({
      processing: true,
      serverSide: true,
      paging: true,
      pageLength: 10,
      ...
      columns: [
        ...
        { data: '' }, // Checkbox
        { data: 'slideshowID' }, // Responsive control
        { data: 'image' },
        { data: 'createdTime' },
        { data: 'status' },
        { data: '' }
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return `<input type="checkbox" class="dt-checkboxes form-check-input" value="${full.slideshowID}">`;
          },
          checkboxes: {
            selectRow: true,
  ...
  $('[tab-name="slideshow"]').on("click", function() {                  
    console.log("Reloaded Slideshow")
    dt_slideshow.ajax.reload(null, false);
  }); 
