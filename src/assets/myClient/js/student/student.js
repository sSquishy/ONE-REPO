$(document).ready(function() {
  ...
  $(document).on('click', '.chikaCard', function() {
      ...
      // Use the HTML of the card-text element to retrieve user formatting (if any),
      // then trim any extra whitespace.
      const description = $(this).find('.card-text').text().trim();
      const image = $(this).find('.chikaImage').attr('src');

      // Display modal title as black and bold, and the description with preserved formatting.
                    ...
                    response.posts.forEach(post => {
                        ...
                        const postCard = `
                            <div class="card border rounded-3 p-3 mb-3 shadow-sm" style="background: #fff; width: 770px; max-width: 100%;">
                                <div class="card-header bg-transparent border-bottom-0 p-2 d-flex align-items-center" style="width: 770px; max-width: 100%;">
