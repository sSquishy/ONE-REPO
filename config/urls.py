...
from mypupqc.views import UsersView

urlpatterns = [
    path("admin/", admin.site.urls),

    path("", UsersView.as_view(template_name="sysClient/Guestt/sysGuest_Homepage.html"), name="guestHome"),
    ...
    # mypupqc Scheduler
    path("", include('mypupqc.urls')),  # This includes the mypupqc URLs

    # myPUPQC Client
    # path("", include('apps.myPUPQC_Client.urls')),  # This includes the myPUPQC_Client URLs
